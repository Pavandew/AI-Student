...
val UserBgDark = Color(0xFF2A2A2A)
val UserBgLight = Color(0xFFE0E0E0)
val ColorModelColor = Color(0xFF676969)
val BackGroundColor = Color(0xFF3A3636)

val MicIconDark = Color.White
val MicIconLight = Color.Black
